...
class Wallet:
    ...
    def get_private_from_wallet(self) -> str:
        ...
        with open(self.privateKeyLocation, "rb") as file:
            # Lire le contenu du fichier et le convertir en chaîne
            # de caractères
            buffer = file.read()
    ...
    def generate_private_key(self) -> Any:
        ...
        # Obtenir la clé privée sous forme de chaîne de caractères
        # en hexadécimal
    ...
    def send_transaction(self, address: str, amount: float) -> Transaction:
        ...
        # du portefeuille, la liste des UnspentTxOuts et le pool de
        # transactions
    ...
    def create_transaction(
        ...
        # Créer une fonction pour convertir un UnspentTxOut en un
        # TxIn non signé
        ...
        # Créer une liste de TxIns non signés à partir
        # des UnspentTxOuts trouvés
